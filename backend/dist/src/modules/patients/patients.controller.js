...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'DOCTOR', 'RECEPTIONIST'),
...
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'DOCTOR', 'RECEPTIONIST'),
    (0, swagger_1.ApiOperation)({ summary: 'Get all patients for the current clinic' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'DOCTOR', 'RECEPTIONIST'),
    (0, swagger_1.ApiOperation)({ summary: 'Get a specific patient by ID with full history' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'DOCTOR', 'RECEPTIONIST'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a patient basic info' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    (0, common_1.Post)(':id/visits'),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'DOCTOR'),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new clinical visit/encounter for a patient' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
